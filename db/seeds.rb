...
question_2 = Question.create!(title: "Color", body: "Of the following colors, which color would you prefer your first car to be?", questionnaire_id: questionnaire_1.id)
...
question_3 = Question.create!(title: "Type", body: "What type of car would you like your first car to be?", questionnaire_id: questionnaire_1.id)
...
answer_2 = Answer.create!(body: "Probably in 2017", question_id: question_5.id)
answer_3 = Answer.create!(body: "Probably in 2018", question_id: question_5.id)
answer_4 = Answer.create!(body: "Probably in 2019", question_id: question_5.id)
...
Prize.create!(title: "Perfume - for him or her", description: "A perfume voucher worth of €65,00 that can be used at your local perfume store or online on your favorite online store!", image_url: "http://www.nstperfume.com/wordpress/wp-content/uploads/2012/08/avon-city-rush-duo.jpg", value: 65, quantity_remaining: 36, win_probability: 0.036, voucher_code: "HD2223BPA12", questionnaire_id: questionnaire_1.id)
